        ...
        if (address2 !== FAILURE) {
          ...
          if (address4 !== FAILURE) {
            ...
            while (address6 !== FAILURE) {
              var index4 = this._offset, elements3 = new Array(3);
              ...
              if (address7 !== FAILURE) {
                ...
                var remaining2 = 0, index5 = this._offset, elements4 = [], address9 = true;
                ...
                if (remaining2 <= 0) {
                  address8 = new TreeNode(this._input.substring(index5, this._offset), index5, elements4);
                  this._offset = this._offset;
                } else {
                  address8 = FAILURE;
                }
              ...
              if (elements3 === null) {
                ...
                address6 = new TreeNode4(this._input.substring(index4, this._offset), index4, elements3);
                this._offset = this._offset;
              }
              if (address6 !== FAILURE) {
            ...
            if (address5 !== FAILURE) {
              ...
              var remaining3 = 0, index6 = this._offset, elements5 = [], address12 = true;
              ...
              if (remaining3 <= 0) {
                address11 = new TreeNode(this._input.substring(index6, this._offset), index6, elements5);
                this._offset = this._offset;
              } else {
                address11 = FAILURE;
              }
      ...
      if (address1 !== FAILURE) {
        ...
        if (address2 !== FAILURE) {
          ...
          while (address4 !== FAILURE) {
            var index3 = this._offset, elements2 = new Array(2);
            var address5 = FAILURE;
            var remaining1 = 1, index4 = this._offset, elements3 = [], address6 = true;
            while (address6 !== FAILURE) {
              address6 = this._read_ws();
              if (address6 !== FAILURE) {
            ...
            if (elements2 === null) {
              ...
              address4 = new TreeNode7(this._input.substring(index3, this._offset), index3, elements2);
              this._offset = this._offset;
            }
            if (address4 !== FAILURE) {
